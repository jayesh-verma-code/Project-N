...
export default function Mri() {
  ...
  const apiUrl = "https://mri-662622027382.europe-west1.run.app"; // Update this to your API URL
  ...
  const handleUploadCT = async () => {
    ...
    try {
      ...
      // Make API call to analyze_mri endpoint
      ...
      // Add initial analysis result message
      ...
      // Immediately call explanation endpoint
      ...
      if (!explanationResponse.ok) {
        throw new Error('Explanation API request failed');
      }
      
      const explanationData = await explanationResponse.json();
      console.log('Explanation response:', explanationData);
      
      // Update the initial result message with explanation
      ...
      // Replace the initial result message with the one containing explanation
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      // Create FormData for chat endpoint (matching Flask API)
      const formData = new FormData();
      ...
      // Add bot response (note: API returns assistant_response, not response)
        ...
        {previewImage && (
          <div className="relative self-start mb-4 w-full">
            <div className="bg-gray-800 p-3 rounded-lg">
              <h3 className="text-blue-400 font-bold mb-2">Ready to analyze MRI scan:</h3>
