...
export default function KidneyCTAnalysis() {
  ...
  const handleUploadCTScan = async () => {
    ...
    try {
      ...
      console.log('Kidney CT analysis response:', data);
      ...
      summaryText += `Condition: ${data.prediction}\n`;
      summaryText += `Confidence: ${data.confidence.toFixed(1)}%\n\n`;
  ...
  const handleSendMessage = async () => {
    ...
    if (!analysisComplete || !sessionId) {
      const promptMessage: Message = {
        id: generateId(),
        text: "Please upload a kidney CT image first before asking questions. I need to analyze an image to provide meaningful discussion.",
        sender: 'bot',
        timestamp: new Date()
      };
    ...
    return (
      <div className="bg-gray-800 rounded-lg mt-4 mb-4 overflow-hidden">
        <div className="flex items-center justify-between p-4 border-b border-gray-700">
          <h3 className="text-blue-400 font-bold">Kidney CT Analysis Results</h3>
          <button
        ...
        {!isAnalysisMinimized && (
          <div className="p-4 space-y-3">
            ...
            {ctData.result_image && (
              <div className="mt-4">
                <span className="text-gray-300 font-medium text-sm">Analyzed Image:</span>
                <div className="mt-2">
                  <img 
          ...
          <div className="p-4">
            <div className="flex items-center justify-between">
              <span className="text-sm text-gray-300">
                Condition: <span className="text-blue-400 font-bold">
                  {ctData.prediction}
                </span>
              </span>
        ...
        <div className="relative bg-gray-800 text-white rounded-full px-4 py-3 pr-36 focus:outline-none focus:ring-2 focus:ring-blue-500">
          <input
            ...
            placeholder={analysisComplete 
              ...
              : "Upload a kidney CT scan image first to enable chat"
            }
