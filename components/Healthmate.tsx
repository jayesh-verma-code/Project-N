...
export default function Home() {
  ...
  //     if (category === 'chest-xray') {
  //       setApiUrl("https://chest-xray-vf3b.onrender.com");
  //       setInitialMessage('Welcome to the Chest X-ray Analysis section. Upload a chest X-ray image for analysis or ask questions about chest X-rays.');
  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      <Sidebar/>
      {/* <Head>
        <title>HealthMate - Chest X-ray Analysis</title>
        <meta name="description" content="AI-powered chest X-ray analysis" />
      ...
      <main className="flex-1 flex flex-col max-w-4xl mx-auto w-full p-4 rounded-lg my-4">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          <button 
            className="bg-blue-600 text-white border border-blue-600 font-bold rounded-full px-3 py-2 text-sm inline-flex items-center"
            onClick={() => {
              setInputValue("What do these X-ray findings mean?");
          ...
          <button 
            className="bg-blue-600 text-white border border-blue-600 font-bold rounded-full px-3 py-2 text-sm inline-flex items-center"
            onClick={() => {
              setInputValue("What are the next steps I should take?");
              setTimeout(handleSendMessage, 100);
            }}
          >
            Next Steps 👣
        ...
        <div className="relative bg-gray-800 text-white rounded-full px-4 py-3 pr-36 focus:outline-none focus:ring-2 focus:ring-blue-500">
          <input
            type="text"
            placeholder="Ask about chest X-rays or medical imaging..."
