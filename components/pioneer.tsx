        ...
        >
          ...
          <div className="flex justify-center overflow-hidden relative h-[500px] xs:h-[550px] sm:h-[500px] md:h-[450px] lg:h-[500px]">
            <AnimatePresence custom={direction} initial={false}>
              ...
              >
                <Card className="bg-black/20 border-white/10 backdrop-blur-sm shadow-lg overflow-hidden">
                  <CardContent className="p-1">
                    ...
                    <div className="flex flex-col sm:flex-row">
                      ...
                      >
                        <img
                          src={pioneers[activeIndex].avatar}
                          alt={pioneers[activeIndex].name}
                      ...
                      <div className="w-full sm:w-3/5 p-4 xs:p-5 sm:p-5 md:p-6 lg:p-8 flex flex-col">
                        ...
                        >
                          ...
                          >
                            {pioneers[activeIndex].description
                              .split(" ")
                              .map((word, wordIndex) => (
                                <motion.span
                                  key={wordIndex}
