...
function UserBubble({ children }: { children: React.ReactNode }) {
    return (
        <div className="ml-auto flex max-w-[75%] items-end gap-2">
            <div className="rounded-2xl rounded-br-sm bg-blue-200 px-4 py-2 text-sm text-sky-900 shadow">
                {children}
            </div>
        </div>
    );
...
function BotBubble({ children }: { children: React.ReactNode }) {
    return (
        <div className="mr-auto flex max-w-[75%] items-end gap-2">
            <div className="rounded-2xl rounded-bl-sm bg-blue-400 text-black px-4 py-2 text-sm shadow">
                {children}
            </div>
        </div>
    );
