    ...
    >
        ...
        <div className="flex gap-2 justify-between items-center mb-20 lg:mb-10 px-4">
            ...
            <div className="absolute left-1/2 transform -translate-x-1/2  top-20  md:top-4">
              <h1 className="text-[#DCFCE7] text-4xl md:text-5xl lg:text-6xl font-bold mb-2 text-center">
                Pet AI
              </h1>
              <p className="text-[#DBEAFE] text-center font-bold text-balance md:text-2xl lg:text-3xl leading-none tracking-normal ">
            ...
            <div className="flex gap-4 mt-5">
              <button className="bg-[#16a34a] rounded-full p-3 cursor-pointer group hover:bg-[#15803d] shadow-lg hover:shadow-xl transition-all duration-300 active:bg-white active:text-[#16a34a] active:scale-95">
                <Phone className="size-4 md:size-5 text-white group-hover:text-gray-100 transition-all duration-300 active:text-[#16a34a]" />
                </button>
              <button className="bg-[#dc2626] rounded-full p-3 cursor-pointer group hover:bg-[#b91c1c] shadow-lg hover:shadow-xl transition-all duration-300 active:bg-white active:text-[#dc2626] active:scale-95">
...
function Card({
    ...
    return(
        <div className="bg-[#1f2937] py-5 px-5 md:px-10 flex flex-col items-center justify-center gap-6 rounded-3xl mb-3 shadow-md transition-transform transform hover:-translate-y-2 hover:shadow-[0_0_15px_rgba(132,150,216,1)] cursor-pointer">
            ...
            <Button className="bg-white text-black hover:bg-[#f0f0f0] rounded-full py-2 px-6 text-sm font-semibold transition duration-300 shadow hover:shadow-md focus:outline-none active:bg-[#e0e0e0] active:text-gray-500">
                <Link href={"/pet-ai/chat"}>Get Started</Link>
            </Button>
        </div>
    )
}
