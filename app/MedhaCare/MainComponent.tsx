  ...
  const medhaCareServiceData = [
    {
      id: 1,
      title: "CuraForgeX",
      description: "Revolutionizing healthcare with AI-driven diagnostics and personalized treatment plans.",
    },
    {
      id: 2,
      title: "FastMediX",
      description: "On-demand medical services connecting patients with healthcare professionals in real-time.",
    },
    {
      id: 3,
      title: "PharmaXPlus",
      description: "AI-powered platform for personalized medication management and adherence tracking.",
    },
    {
      id: 4,
      title: "AmboRapid",
      description: "AI-enhanced ambulance services for faster response times and optimized routing.",
    },
  ];
  return (
