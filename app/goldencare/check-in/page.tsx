  ...
  const fetchUserData = async (userName: string) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage({
          type: "error",
          text: "User not found. Please create a profile first.",
        });
      }
    } catch (error) {
      setMessage({
  ...
  const handleCheckInSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        setMessage({
          type: "error",
          text: "Failed to submit check-in. Please try again.",
        });
      }
    } catch (error) {
      setMessage({
            ...
            <Card className="backdrop-blur-md bg-slate-900/40 border-slate-700/30 shadow-xl overflow-hidden">
              ...
              <CardContent>
                <p className="text-slate-400 mb-6">
                  Please enter your name to continue with your daily health
                  check-in.
                </p>
                  ...
                  <CardContent className="pt-6">
                    <div className="space-y-6">
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <Button
                                ...
                                onClick={() =>
                                  setSystolicBP(Math.max(0, systolicBP - 1))
                                }
                              >
                                -
                              </Button>
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              <Input
                                ...
                                value={diastolicBP}
                                onChange={(e) =>
                                  setDiastolicBP(parseInt(e.target.value))
                                }
                              ...
                              <Button
                                ...
                                className="px-3 text-white bg-slate-800/50 border-slate-700/50 hover:bg-slate-700/50 hover:border-slate-600/80"
                                onClick={() =>
                                  setDiastolicBP(Math.max(0, diastolicBP - 1))
                                }
                              >
                                -
                              </Button>
                          ...
                          <div>
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <Button
                                ...
                                className="px-3 text-white bg-slate-800/50 border-slate-700/50 hover:bg-slate-700/50 hover:border-slate-600/80"
                                onClick={() =>
                                  setBloodSugar(Math.max(0, bloodSugar - 1))
                                }
                              >
                                -
                              </Button>
                      ...
                      <div>
                        <Label
                          htmlFor="mood"
                          className="flex items-center mb-2 text-slate-300"
                        >
                ...
                >
                  ...
                  <div className="flex flex-row items-center justify-center">
                    <Button className="bg-gradient-to-r from-yellow-600 to-amber-600 hover:from-yellow-700 hover:to-amber-700 shadow-lg hover:shadow-amber-500/20 transition-all duration-300 py-6 text-white">
                      <Link href={"/Healthmate?category=biopsy"}>
                        Go To Chatbot
                      </Link>
                    </Button>
                  </div>
