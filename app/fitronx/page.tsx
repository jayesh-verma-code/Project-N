          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex items-center">
              ...
              <span className="text-gray-300 text-sm">
                kavalivishal22032003@gmail.com
              </span>
            </div>
          </div>
        </Card>
        ...
        <div className="min-h-screen bg-gradient-to-b from-black to-gray-900 dark:from-black dark:to-gray-900 text-white overflow-hidden">
            ...
            <div className="container mx-auto max-w-5xl">
              <div className="text-center mb-16">
                <h2 className="text-3xl md:text-4xl font-bold mb-6">
                  FitronX is a smart, community-driven fitness subscription
                  service
                </h2>
                <p className="text-lg mb-8 max-w-3xl mx-auto text-gray-300">
                  Built for corporates and apartment communities who care about
                  well-being and togetherness. We bring the energy right to your
                  doorstep — organizing engaging fitness competitions that are
                  fun, inclusive, and tech-powered.
                </p>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-12 mb-16">
                <Card className="p-8 shadow-lg hover:shadow-xl transition-shadow bg-gray-800 border-gray-700">
                  ...
                  <p className="text-gray-300">
                    Our team visits residential communities and hosts
                    interactive challenges for all age groups (7–50).
                    Participants take part in beginner-friendly movements like
                    push-ups, squats, planks, and curls — no gym required!
                  </p>
                </Card>
                ...
                <Card className="p-8 shadow-lg hover:shadow-xl transition-shadow bg-gray-800 border-gray-700">
                  ...
                  <p className="text-gray-300">
                    Using Media-Pipe AI-based body tracking, our software
                    captures movements in real-time through your device camera.
                    It automatically counts reps, tracks posture, and times your
                    performance — all hands-free.
                  </p>
                </Card>
              </div>
              ...
              <div className="grid md:grid-cols-2 gap-12">
                <Card className="p-8 shadow-lg hover:shadow-xl transition-shadow bg-gray-800 border-gray-700">
                  ...
                  <p className="text-gray-300 mb-2">
                    In just 1 minute, participants receive an instant
                    personalized report via email, including:
                  </p>
                  <ul className="list-disc ml-6 text-gray-300">
                    <li>Performance summary</li>
                    <li>
                      Suggested exercises (based on age, experience & gender)
                    </li>
                ...
                <Card className="p-8 shadow-lg hover:shadow-xl transition-shadow bg-gray-800 border-gray-700">
                  ...
                  <p className="text-gray-300">
                    We combine gamification, real-time feedback, and health
                    analytics to create an environment where people feel
                    motivated to take the first step toward a healthier life —
                    without needing fancy gear or gym memberships.
                  </p>
                </Card>
              </div>
            </div>
            ...
            <div className="container mx-auto max-w-5xl px-4">
              <div className="text-center mb-12">
                ...
                <p className="text-lg text-gray-300">
                  Fill out the form below to get started with FitronX
                </p>
              </div>
              ...
              <Card className="p-8 shadow-lg hover:shadow-xl transition-shadow bg-gray-800 border-gray-700 max-w-3xl mx-auto">
                <div className="flex flex-col md:flex-row items-center gap-8">
                  ...
                  <div className="md:w-2/3 text-center md:text-left">
                    ...
                    <p className="text-white-400 hover:text-blue-400 transition-all duration-300 font-medium mb-4">
                      Head of Product & Community Innovation, NirveonX
                    </p>
                    <p className="text-gray-300 mb-6">
                      Vishal Kavali leads the design and execution of NirveonX's
                      AI-powered community wellness programs. He specializes in
                      building scalable health-tech products that fuse computer
                      vision, automation, and real-world engagement — making
                      fitness accessible for both corporate and middle-class
                      communities. With a keen eye for strategy and strong
                      on-ground insight, Vishal bridges the gap between
          ...
          <footer className="bg-black text-white py-8">
            <div className="container mx-auto px-4 text-center">
              <p>
                © {new Date().getFullYear()} FitronX by NirveonX. All rights
                reserved.
              </p>
            </div>
          </footer>
