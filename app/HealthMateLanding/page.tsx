          ...
          <div className="flex gap-2 justify-between items-center mb-20 lg:mb-10 px-4">
            ...
            <div className="flex gap-4 mt-5">
              <Link
                ...
                aria-label="Start audio call with HealthMate Assistant"
              >
                <motion.div
              ...
              <Link
                ...
                aria-label="Start video call with HealthMate Assistant"
              >
                <motion.div
          ...
          <div className="mt-20 lg:mt-[120px] px-4 lg:px-36">
            ...
            >
              ...
              <FeatureCard
                ...
                imagePath="/Monitor_health.svg"
                icon="trends"
              />
              <FeatureCard
                title="Receive Health Alerts"
                imagePath="/healthcare-alert.svg"
                icon="alerts"
              />
              <FeatureCard
                title="Upload Health Reports"
                imagePath="/doctor-ext.svg"
                icon="upload"
              />
            </motion.div>
          </div>
...
const FeatureCard = ({
  ...
  return (
    ...
    >
      ...
      <div
        className="relative mb-3 lg:mb-4 w-full aspect-square max-w-[130px] transform-gpu"
      ...
      >
        ...
        <div
          className="relative overflow-hidden w-full h-full rounded-full z-10 transform-gpu"
      ...
      <div
        className="flex flex-col items-center gap-3 sm:gap-4 lg:gap-[20.34px] w-full transform-gpu"
